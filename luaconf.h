...
#define LUA_VDIR  LUA_VERSION_MAJOR "." LUA_VERION_MINOR
#if defined(_WIN32)
#define LUA_LDIR "!\\lua\\"
#define LUA_CDIR "!\\"
#else
...
#define LUA_INTEGER "%" LUA_INTEGER_FRMLEN "d"
...
#if !defined(LUA_USE_C89)
#define lua_number2str2(L,b,sz,f,n) ((void)L, l_sprintf(l,sz,f,(LUAI_UACNUMBER)(n)))
#endif
